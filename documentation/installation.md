...
1. **Back up first** — `php bin/backup-database.php` (see
   [`operations.md`](operations.md#backuprestore)). Every schema migration requires a fresh
   backup immediately before running it.
