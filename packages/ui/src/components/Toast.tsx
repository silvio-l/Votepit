...
function Glyph({ type }: { type: ToastType }) {
  ...
  return (
    <span
      aria-hidden="true"
      className={cx(
        'flex size-6 shrink-0 items-center justify-center rounded-vp-sm animate-vp-stamp',
        accentClasses[type],
...
/**
 * Transient page-level confirmation. A white plane with the overlay's 2px
 * ink edge, a coloured glyph and a thin progress bar that drains over the
 * auto-dismiss window (pauses
