...
export function RoadmapCard({
  ...
  const inner = (
    ...
    >
      <p
        className={cx(
          'text-vp-base font-semibold text-vp-ink leading-5 line-clamp-3 text-pretty tracking-[-0.01em]',
          href &&
            'decoration-2 underline-offset-[0.2em] decoration-vp-underline transition-colors group-hover:underline',
        )}
      >
        {title}
      </p>
