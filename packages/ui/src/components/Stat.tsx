  ...
  return (
    ...
    >
        ...
        {icon && (
          <span
            ...
            className={cx(
              ...
              tone === 'default' && 'bg-vp-surface-frost text-vp-text-muted',
            )}
          >
            {icon}
          </span>
      ...
      <div className="flex items-baseline gap-2 flex-wrap">
        <span className="font-mono-num font-bold text-vp-2xl leading-8 tracking-tight text-vp-ink">
          {value}
        </span>
        {delta && (
          <span
      ...
      {clamped !== undefined && (
        <div className="h-1.5 w-full rounded-full bg-vp-surface-sunken overflow-hidden" aria-hidden="true">
          <span
            className={cx(
              'block h-full rounded-full transition-[width] duration-500 ease-vp-out',
