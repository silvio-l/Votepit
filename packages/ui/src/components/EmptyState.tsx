...
function BallotStack({ compact }: { compact: boolean }) {
  ...
  return (
    ...
    >
      <rect x="10" y="6" width="36" height="44" fill="var(--color-vp-surface)" stroke="currentColor" strokeWidth="1.5" strokeDasharray="3 3" />
      <rect x="16" y="15" width="6" height="6" stroke="currentColor" strokeWidth="1.5" />
      <path d="M26 18h14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      <rect x="16" y="25" width="6" height="6" stroke="currentColor" strokeWidth="1.5" />
      <path d="M26 28h10" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      <rect x="16" y="35" width="6" height="6" stroke="currentColor" strokeWidth="1.5" />
  ...
  return (
    ...
    >
      <span
        aria-hidden="true"
        className={cx(
          'flex items-center justify-center rounded-vp-xl bg-vp-bg',
      ...
      <Heading
        className={cx(
          'font-archivo font-bold text-vp-ink tracking-[-0.02em]',
          compact ? 'text-vp-base' : 'text-vp-xl mt-1',
        )}
      >
        {title}
      </Heading>
