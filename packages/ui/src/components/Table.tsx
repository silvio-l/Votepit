...
export function TableBody({ children }: { children: ReactNode }) {
  return <tbody className="divide-y divide-vp-border-subtle">{children}</tbody>
}
...
export function TableHeaderCell({
  ...
  return (
    <th
      scope="col"
      className={cx(
        'px-4 sm:px-5 py-2.5 text-vp-2xs font-semibold uppercase tracking-[0.08em] text-vp-text-muted whitespace-nowrap border-b border-vp-border-subtle',
