...
final class BrandingValidatorTest extends TestCase
{
    ...
    // ── primaryColor(): WCAG 1.4.3 contrast on the derived accent-strong ──────

    public function test_primary_color_accepts_default_teal(): void
    {
        // Default board accent (tokens.css --vp-primary) — must keep passing.
        self::assertSame('#1fa890', BrandingValidator::primaryColor('#1fa890'));
    }

    public function test_primary_color_accepts_dark_shade(): void
    {
        self::assertSame('#112233', BrandingValidator::primaryColor('#112233'));
    }

    public function test_primary_color_rejects_pale_shade_even_when_format_valid(): void
    {
        // Pale yellow: even after the 70%-towards-black derivation, the
        // accent-strong button background stays too light for white text.
        self::assertNull(BrandingValidator::primaryColor('#ffffcc'));
    }

    public function test_primary_color_rejects_white(): void
    {
        self::assertNull(BrandingValidator::primaryColor('#ffffff'));
    }

    public function test_primary_color_rejects_invalid_format(): void
    {
        self::assertNull(BrandingValidator::primaryColor('#abc;color:red'));
    }

    // ── secondaryColor(): WCAG 1.4.3 contrast on the raw ink/CTA background ───

    public function test_secondary_color_accepts_dark_shade(): void
    {
        self::assertSame('#445566', BrandingValidator::secondaryColor('#445566'));
    }

    public function test_secondary_color_rejects_light_shade_even_when_format_valid(): void
    {
        self::assertNull(BrandingValidator::secondaryColor('#eeeeee'));
    }

    public function test_secondary_color_rejects_white(): void
    {
        self::assertNull(BrandingValidator::secondaryColor('#ffffff'));
    }

    public function test_secondary_color_rejects_invalid_format(): void
    {
        self::assertNull(BrandingValidator::secondaryColor('not-a-color'));
    }
}
