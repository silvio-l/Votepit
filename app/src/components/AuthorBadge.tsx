 ...
 * or a visible one that never set a username. The owner/moderator badge is
 * appended in every branch regardless of visibility — see RoleBadge.
 */
  ...
  if (isSelf) {
    return (
      <span className={wrapperClass}>
        ...
        {currentUserRole !== null && <RoleBadge role={currentUserRole} />}
      </span>
    )
  }
