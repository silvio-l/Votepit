 ...
 *  3. Moderator sees members but NOT the invite form / remove / revoke controls
 *  4. Non-member (403 from GET /admin/members) → access denied message
...
const OWNER_MEMBERS_RESPONSE = {
  members: [
    { user_id: 1, role: 'owner', created_at: '2026-01-01T00:00:00Z' },
    { user_id: 2, role: 'moderator', created_at: '2026-01-02T00:00:00Z' },
  ],
  invites: [
    {
      id: 5,
...
const MODERATOR_MEMBERS_RESPONSE = {
  members: [
    { user_id: 1, role: 'owner', created_at: '2026-01-01T00:00:00Z' },
    { user_id: 2, role: 'moderator', created_at: '2026-01-02T00:00:00Z' },
  ],
...
describe('MembersPage — moderator view', () => {
  it('shows members but hides invite form and mutation controls', async () => {
    makeFetchMock([{ body: BOOTSTRAP_OK }, { body: MODERATOR_MEMBERS_RESPONSE }])
