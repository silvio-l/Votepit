...
const en = {
  ...
  milestoneFirstIdeaTitle: 'Your first idea is in!',
  milestoneFirstIdeaBody: 'Your board is alive — keep going.',
  milestoneFirstExternalTitle: 'Your first outside idea!',
  milestoneFirstExternalBody: 'Someone else just joined in — your board is growing beyond you.',
  milestoneTenIdeasTitle: '10 ideas reached!',
  milestoneTenIdeasBody: 'Your board is picking up momentum.',
} satisfies typeof de
