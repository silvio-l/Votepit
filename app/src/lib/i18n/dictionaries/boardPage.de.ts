export default {
  ...
  milestoneFirstIdeaTitle: 'Die erste Idee ist da!',
  milestoneFirstIdeaBody: 'Dein Board lebt — weiter so.',
  milestoneFirstExternalTitle: 'Die erste Fremdidee!',
  milestoneFirstExternalBody: 'Jemand anderes hat mitgemacht — dein Board wächst über dich hinaus.',
  milestoneTenIdeasTitle: '10 Ideen erreicht!',
  milestoneTenIdeasBody: 'Dein Board nimmt Fahrt auf.',
}
